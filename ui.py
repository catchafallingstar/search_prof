...
def configure_page(title: str) -> None:
        ...
        if theme == "dark":
                ...
                div[data-testid="stVerticalBlockBorderWrapper"], div[data-testid="stForm"] { background: #102b43; border-color: #54708b; }
                label, [data-testid="stWidgetLabel"] p { color: #ffffff !important; }
                /* Improve contrast for Streamlit info/alert boxes (preview message) */
                .stAlert, .stAlert div, [data-testid="stInfo"], [data-testid="stAlert"] {
                    background-color: rgba(10,30,40,0.6) !important;
                    border-color: rgba(255,255,255,0.04) !important;
                    color: #ffffff !important;
                }
                .stAlert .stMarkdown, [data-testid="stInfo"] .stMarkdown {
                    color: #ffffff !important;
                }
